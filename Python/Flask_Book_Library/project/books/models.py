...
class Book(db.Model):
    ...
    def __init__(self, name, author, year_published, book_type, status='available'):
        ...
        self.author = Markup.escape(author)
        self.year_published = Markup.escape(year_published)
        self.book_type = Markup.escape(book_type)
        self.status = Markup.escape(status)
